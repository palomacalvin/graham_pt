...
export default function MNProjectLocationSection({
  ...
  const handleResetCountyDefaults = () => {
    ...
    setProjectData((prev) => ({
      ...prev,
      userLandValue: countyAvgValue ?? prev.userLandValue,
      useEstimatedCapacityFactor:
        selectedCounty.est_capacity_factor ?? prev.useEstimatedCapacityFactor,
    }));
  };
  ...
  return (
    ...
    <section>
      ...
      <LocationSelector
        ...
        onSelectCounty={(county) => {
          ...
          setProjectData((prev) => ({
            ...
            userLandValue: countyAvgValue ?? prev.userLandValue,
              useEstimatedCapacityFactor:
              county?.est_capacity_factor ?? prev.useEstimatedCapacityFactor,
      ...
      <br></br>
          <label>
            If applicable, enter the PILOT Annual Payment amount ($):
            <input
              type="number"
              name="pilotPayment"
